...
- [ ] 6.8 Add self-healing actions from diagnostics: restart gateway, clear snapshot cache, reinstall service.
  ...
  - Files: `diagnostics/repair.rs`, `diagnostics/watchdog.rs`, `service/mod.rs`, `src/components/settings/DiagnosticsPanel.tsx`, `src/components/settings/diagnosticsRepairView.ts`, `src/lib/ipc/types.ts`.
