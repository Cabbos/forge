...
- 工作面板首次打开停在选择器，使用 Base UI Tabs、cmdk、react-resizable-panels、react-diff-viewer-continued 与 xterm.js；用户选择后才打开当前改动、临时验证终端、本机网页/文件预览、工作区文件或某个具体子任务，并按当前任务分别恢复 Tab。
