...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::workspace_terminal::start_workspace_terminal,
            ipc::workspace_terminal::write_workspace_terminal,
            ipc::workspace_terminal::resize_workspace_terminal,
            ipc::workspace_terminal::close_workspace_terminal,
