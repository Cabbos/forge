  ...
  return (
    <section>
      ...
      <ForgeSurface className="px-3 py-3">
        ...
        {gateCopy && (
          <div className="mt-2 rounded border border-[rgba(var(--forge-amber-rgb),0.22)] bg-[rgba(var(--forge-amber-rgb),0.06)] px-2 py-1.5 text-[11px] text-[var(--forge-warning-strong)]">
            {gateCopy}
          </div>
        )}
