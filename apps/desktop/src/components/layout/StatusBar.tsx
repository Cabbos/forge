...
export function StatusBar() {
  ...
  return (
    <footer className="h-8 flex items-center px-4 text-[11px] text-muted-foreground/40 flex-shrink-0 gap-3 select-none border-t border-border/20">
      ...
      {active && active.costUsd > 0 && <span className="font-mono text-muted-foreground/30">${active.costUsd.toFixed(4)}</span>}
