...
only task-level score evidence is available, reports CI-default gate
totals/pass/fail/unknown counts beside the full matrix, and includes
acceptance domain/tier breakdowns. Failed, manual, and unknown gate details
