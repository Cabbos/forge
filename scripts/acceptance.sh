...
Runs the Forge Level 3 runtime acceptance gates:
  ...
  22. Desktop Phase 7 provider probe/model catalog and A2A worker lifecycle smoke specs
...
COMMAND_LABELS=(
  ...
  "desktop Phase 7 provider probe/model catalog and A2A worker lifecycle smoke specs"
