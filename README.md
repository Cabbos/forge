...
- Settings: models with config-defined provider profiles, no-auth local provider support, manual provider compatibility probes, workspace, tools, memory, data, diagnostics, scheduler, and general service/autostart surfaces.
