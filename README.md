...
- Settings: models with config-defined provider profiles surfaced in the desktop catalog, no-auth local provider support, manual provider compatibility probes, workspace, tools, memory, data, diagnostics, scheduler, and general service/autostart surfaces.
