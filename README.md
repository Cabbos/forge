...
- Phase 8 desktop UI evidence helpers now surface recovery commands from preflight through the disposable loop status/runbook summaries when local screenshot or window observation is blocked.
